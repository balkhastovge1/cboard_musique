...
#define MBED_CONF_PLATFORM_MINIMAL_PRINTF_ENABLE_FLOATING_POINT               1                                                                                                // set by application[NUCLEO_F429ZI]
...
#define MBED_CONF_SD_SPI_CLK                                                  PE_2                                                                                             // set by application[NUCLEO_F429ZI]
#define MBED_CONF_SD_SPI_CS                                                   PE_4                                                                                             // set by application[NUCLEO_F429ZI]
#define MBED_CONF_SD_SPI_MISO                                                 PE_5                                                                                             // set by application[NUCLEO_F429ZI]
#define MBED_CONF_SD_SPI_MOSI                                                 PE_6                                                                                             // set by application[NUCLEO_F429ZI]
...
#define STM32_D11_SPI_ETHERNET_PIN                                            PB_5                                                                                             // set by application[NUCLEO_F429ZI]
// Macros
